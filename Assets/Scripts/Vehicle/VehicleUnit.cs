...
public class VehicleUnit : MonoBehaviour
{
    ...
    [SerializeField] private EffectsControl effectsControl;
    ...
    void StopVehicle()
    {
        ...
        if (inCrash || !stopInParking) vehicleManager.AddVehicleToFree(managerIndex, type, vehicleName.GetHashCode());
