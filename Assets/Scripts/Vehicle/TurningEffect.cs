...
public class TurningEffect : MonoBehaviour
{
    ...
    {
        if (leftFrontLightEffect != null) leftFrontLightEffect.SetRendererSortingLayerByID(newID);
        if (rightFrontLightEffect != null) rightFrontLightEffect.SetRendererSortingLayerByID(newID);
    }
